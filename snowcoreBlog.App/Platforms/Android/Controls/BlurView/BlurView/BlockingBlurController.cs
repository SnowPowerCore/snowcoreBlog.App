 ...
 */
     ...
     */
        ...
        private void Init(int measuredWidth, int measuredHeight)
        {
            ...
            Debug.WriteLine($"Init( width: {measuredWidth}, height: {measuredHeight} )");
     ...
     */
        ...
        {
            Debug.WriteLine("DeferBitmapCreation()");
        ...
        {
            Debug.WriteLine($"AllocateBitmap( width: {measuredWidth}, height: {measuredHeight} )");
     ...
     */
        ...
        {
            Debug.WriteLine("UpdateBlurViewSize()");
        ...
        {
            Debug.WriteLine($"SetBlurAutoUpdate( {enabled} )");
