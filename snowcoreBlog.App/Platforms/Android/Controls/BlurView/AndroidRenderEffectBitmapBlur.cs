...
public class AndroidRenderEffectBitmapBlur : IBlurImpl
{
    ...
    public void Blur(Bitmap input, Bitmap output)
    {
        if (_tempImageView == null)
        {
            System.Diagnostics.Debug.WriteLine("AndroidRenderEffectBitmapBlur: Blur() called before successful Prepare()");
            return;
        }
        ...
        {
            System.Diagnostics.Debug.WriteLine($"AndroidRenderEffectBitmapBlur: Error during blur: {ex.Message}");
        }
    }
