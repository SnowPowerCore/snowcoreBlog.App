...
public class InternalCustomApplicationTheme : ApplicationTheme
{
    public static Color PrimaryColor { get; } = Color.FromRgba(81, 43, 212, 255); // #512BD4
    ...
    public static Color SecondaryColor { get; } = Color.FromRgba(223, 216, 247, 255); // #DFD8F7
    ...
    public static Brush PrimaryBrush { get; } = new SolidColorBrush(PrimaryColor);
    public static Brush SecondaryBrush { get; } = new SolidColorBrush(SecondaryColor);
    ...
    protected override void OnApply()
    {
        ActivityIndicatorStyles.Default = _ =>
            _.Color(IsLightTheme ? PrimaryColor : White);
        ...
        ButtonStyles.Default = _ => _
            ...
            .BackgroundColor(IsLightTheme ? PrimaryColor : PrimaryDark)
        ...
        ProgressBarStyles.Default = _ => _
            .ProgressColor(IsLightTheme ? PrimaryColor : White)
        ...
        SliderStyles.Default = _ => _
            .MinimumTrackColor(IsLightTheme ? PrimaryColor : White)
            .MaximumTrackColor(IsLightTheme ? Gray200 : Gray600)
            .ThumbColor(IsLightTheme ? PrimaryColor : White)
        ...
        SwitchStyles.Default = _ => _
            .OnColor(IsLightTheme ? PrimaryColor : White)
            .ThumbColor(White)
            ...
            .VisualState("CommonStates", "On", MauiControls.Switch.OnColorProperty, IsLightTheme ? SecondaryColor : Gray200)
            .VisualState("CommonStates", "On", MauiControls.Switch.ThumbColorProperty, IsLightTheme ? PrimaryColor : White)
