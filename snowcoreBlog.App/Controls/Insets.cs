...
public partial class Insets : BindableObject
{
    ...
    private static void StatusBarStyleChanged(BindableObject bindable, object oldValue, object newValue)
    {
    ...
    private static void EdgeToEdgeChanged(BindableObject bindable, object oldValue, object newValue)
    {
    ...
    public static Insets Current { get; } = new();

    private Thickness _insets = new(0);
    ...
    internal void Init(Page mainPage)
    {
        ...
        {
            var page = (Page)v;
            if (page.Window is not default(Window))
            {
                UpdateEdgeToEdge(page);
                UpdateStatusBarStyle(page);
            }
