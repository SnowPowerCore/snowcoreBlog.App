...
{
    public Thickness NegativeInsetsThickness => new(-InsetsThickness.Left, -InsetsThickness.Top, -InsetsThickness.Right, -InsetsThickness.Bottom);
    ...
    private static void UpdateStatusBarAppearance(UIWindow? window)
    {
        ...
        while (vc.PresentedViewController is not default(UIViewController))
        {
