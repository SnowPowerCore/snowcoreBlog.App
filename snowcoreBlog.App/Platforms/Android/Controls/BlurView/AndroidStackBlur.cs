...
public class AndroidStackBlur : IBlurImpl
{
    ...
    public void Blur(Bitmap input, Bitmap output)
    {
        ...
        {
            Debug.WriteLine("AndroidStackBlur: Input bitmap is null or recycled");
            return;
        }
        
        if (output == null || output.IsNullOrDisposed() || output.IsRecycled)
        {
            Debug.WriteLine("AndroidStackBlur: Output bitmap is null or recycled");
            return;
        }
        
        if (input.Width != output.Width || input.Height != output.Height)
        {
            Debug.WriteLine("AndroidStackBlur: Input and output bitmaps must have the same dimensions");
            return;
        }
        ...
        {
            Debug.WriteLine($"AndroidStackBlur: Error during blur: {ex.Message}");
        }
    }
    ...
    private static void StackBlurBitmap(Bitmap input, Bitmap output, int radius)
    {
        ...
        {
            Debug.WriteLine("AndroidStackBlur: Output bitmap was recycled during blur processing");
            return;
        }
